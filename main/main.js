...
// Второй экземпляр не поднимаем, а показываем уже открытое окно.
//
// Это не про удобство, а про сохранность данных: обе копии пишут в ОДНУ папку
// в %APPDATA% — сетку, индекс EPG, кэши, — и их записи затирали бы друг
// друга. Ярлык нажать дважды легко, а последствия были бы невидимыми.
